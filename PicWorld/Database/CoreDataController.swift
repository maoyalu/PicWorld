...
class CoreDataController: NSObject, DatabaseProtocol, NSFetchedResultsControllerDelegate {
    ...
    func createDefaultEntries(){
        let _ = addLocation(name: "St Michael's Uniting Church", descript: "St Michael's is a unique church in the heart of the city. It is not only unique for its relevant, contemporary preaching, but for its unusual architecture.", latitude: -37.8143, longitude: 144.9697, imageFilename: "default")
